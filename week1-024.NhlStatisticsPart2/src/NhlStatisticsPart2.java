    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.println("Wich player's statistics you want ?");
                String playerUser = reader.nextLine();
                NHLStatistics.searchByPlayer(playerUser);
                // Ask the user first which player's statistics are needed and then print them.
            } else if (command.equals("club")) {
                System.out.println("Wich club statistics you want ?");
                String playerClub = reader.nextLine();
                NHLStatistics.sortByPoints();
                NHLStatistics.teamStatistics(playerClub);
